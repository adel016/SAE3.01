...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : mer. 02 avr. 2025 à 20:34
...
--
-- Déchargement des données de la table `sys_config`
--

INSERT INTO `sys_config` (`variable`, `value`, `set_time`, `set_by`) VALUES
('diagnostics.allow_i_s_tables', 'OFF', '2024-09-23 09:29:17', NULL),
('diagnostics.include_raw', 'OFF', '2024-09-23 09:29:17', NULL),
('ps_thread_trx_info.max_length', '65535', '2024-09-23 09:29:17', NULL),
('statement_performance_analyzer.limit', '100', '2024-09-23 09:29:17', NULL),
('statement_performance_analyzer.view', NULL, '2024-09-23 09:29:17', NULL),
('statement_truncate_len', '64', '2024-09-23 09:29:17', NULL);
...
DROP VIEW IF EXISTS `version`;
CREATE ALGORITHM=UNDEFINED DEFINER=`mysql.sys`@`localhost` SQL SECURITY INVOKER VIEW `version` (`sys_version`, `mysql_version`) AS   select '2.1.2' AS `sys_version`,version() AS `mysql_version`  ;
